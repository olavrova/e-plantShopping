...
function ProductList({ onHomeClick }) {
    ...
    const cartItems = useSelector(state => state.cart.items); // Adjust selector to your state shape
    const totalItems = cartItems.reduce((sum, item) => sum + item.quantity, 0); // If each item has a quantity
